 ...
 */
#ifndef TRACEPING_BASELINE_H
#define TRACEPING_BASELINE_H

#include "common.h"

#include <stdio.h>

#define TRACEPING_BASELINE_MAX_HOPS 255

typedef struct {
    char target[TRACEPING_MAX_TARGET];
    char resolved_ip[INET_ADDRSTRLEN];
    char captured_at[64];
    int hop_count;
    MtrHopStats hops[TRACEPING_BASELINE_MAX_HOPS];
} MtrBaseline;
